            ...
            .Grid(grid =>
{
    ...
    for( int i = 1;i <= 40 ;i++){
    grid.Item(4).Background(Colors.White).Border(1).BorderColor(Colors.Black).Height(60).Padding(1).Text(text =>
    {
        ...
        text.Span(barcode).FontFamily("Libre Barcode 39").FontSize(30);
